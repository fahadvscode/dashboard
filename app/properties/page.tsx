...
export default function CanadaProperties() {
  ...
  return (
    <div className="p-4 md:p-6 lg:p-8 pb-20 md:pb-8">
      <div className="mb-6 mt-4 flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
        <div>
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-blue-600 text-white text-sm font-semibold hover:bg-blue-700"
        >
