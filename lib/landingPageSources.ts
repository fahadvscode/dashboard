...
export const BUILTIN_LANDING_PAGE_SOURCES: LandingPageSource[] = [
  ...
  { table_name: 'fahad_sells_leads', display_name: 'Fahad Sells', page_name: 'Fahad Sells', site_url: 'https://fahadsells.com', name_style: 'first_name', enabled: true, has_crm: false, builtin: true },
