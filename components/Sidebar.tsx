...
import { Home, Calendar, Mail, Building2, Mailbox, LogOut, FileText, MessageSquare, Smartphone, Link2, Copy, Check, Edit, ChevronDown, ChevronUp, Brain, Upload, CheckSquare, FolderOpen } from 'lucide-react'
